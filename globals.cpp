...
int player_armor = 0;
int player_magic_resist = 0;         // odporność magiczna gracza
int player_armor_pen = 0;            // przebicie pancerza przeciwnika przez gracza
...
// Mana i czary
int player_mana = 100;               // aktualna mana (baza 100)
int player_maxmana = 100;            // maksymalna mana
int player_spell_power = 0;          // siła zaklęć
int player_magic_resist_pen = 0;     // przebicie odporności magicznej przeciwnika

// Stun
int enemy_stun_turns = 0;            // ile tur przeciwnik jest ogłuszony
...
magic_item_def magic_items[] = {
	...
	{"Różdżka Zniszczenia",   500,   300,  120, 15,   0,   0,  "   +120 siły zaklęć, +300 many, +15 przebicia MR"},
	{"Naszyjnik Uzdrowicielki", 220, 100,   5,  0,    0,   300, "	+100 many, +5 siły zaklęć, +300% bazowej regeneracji many"},
	{"Tarcza Anioła",         450,   0,    0,   0,    30, 150,  "   +30 odporności magicznej, +100% bazowej regeneracji many"}
};
